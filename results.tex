...
\begin{table}[ht]
  ...
  Corresponding low values occur around %~10s, 50-55s, 75s, while aligned raises appear around ~20s and 45s. Statistical tests in Table~\ref{tab:clip006_pos_stats} confirm the visual trend, where peaks in joy trace often coincide with rises in the orange intensity curve. 
