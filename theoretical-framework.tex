...
Text-based systems rely strongly on lexical cues, and research shows different types of words carries different levels of intensity (källa****chau 2024****). This highlights both a strength and a limitation of text-based emotion recognition, as emotional sentiment may go undetected unless it is verbalized, since emotions may not necessarily be expressed through text (källa**** Soleymani2017****).
...
This suggests that loudness varies far less reliably than pitch across anger, happiness and fear. According to \autocite{Banse1996} is the fundamental frequency (pitch) the most studied and perceptually prominent feature. Happiness is one of the emotions that can be identified from pitch, yet both \textcites{Banse1996}{Ekberg2023} shows this positive emotion a wide overall acoustic spread. 
...
As the format of the interviews are semi-structured and involve spontaneous speech unlike acted datasets, a well-known challenge emerges. Spontaneous vocal data tends to involve more neutral expressions, and research have shown some emotional classifiers to have a lower accuracy in detecting neutral statements (källa****cao 2015****). This is also supported by other research, stating that acted speech shows higher levels of intensity (källa****Chakr 2016****). While spontaneous speech presents some documented challenges, it also reflects real word conditions.
